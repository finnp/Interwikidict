...
function translate() {
    ...
    new Ajax.Request("/query/"+lang.from.object.iso+"/"+lang.to.object.iso+"/"+$('translateinput').value, {
        onLoading: function(){
          //loading
        },
		onSuccess: function(transport){
        $('wikioutput').innerHTML  = transport.responseText;
...
window.onload=function()
{
    ...
    //Draggables
     ...
     new Draggable('lang_fi', draggable_options);
     //Droppables
